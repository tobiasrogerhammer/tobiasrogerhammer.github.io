...
function startGame() {
    ...
    setTimeout(updateTimer, randomNum);
...
function stopTimer() {
    if (rounds === 5) {
        ...
        document.getElementById("bestScore").innerHTML = 'Best average:  ' + bestRound + '0 ms';
        ...
        document.getElementById("timer").innerHTML = randomNum + '0ms reaction time';
...
function resetGame() {
    ...
    document.getElementById("bestScore").innerHTML = 'Best average:  ' + bestRound + '0ms';
